...
int main(int argc, char* argv[]) {
    ...
    std::cout << "=== KNN with k-d Tree Classifier Test ===" << std::endl;
    ...
    try {
        ...
        // Train KNN with k-d tree
        std::cout << "\nBuilding k-d tree..." << std::endl;
        ...
        std::cout << "Build time: " << trainTime.count() << " ms" << std::endl;

        // Predict on test set
        std::cout << "\nTesting KNN with k-d tree..." << std::endl;
        ...
        // Save to JSON
        Metrics::saveMetricsJSON(true_labels, predicted_labels, outputFile, "KNN_KDTree");

        std::cout << "\n=== Test Complete ===" << std::endl;
        std::cout << "Results saved to: " << outputFile << std::endl;
        std::cout << "\nTo visualize results, run:" << std::endl;
        std::cout << "  python visualization/visualize_metrics.py " << outputFile << std::endl;
        std::cout << "\nTo compare with Basic KNN, run:" << std::endl;
        std::cout << "  python visualization/visualize_metrics.py metrics.json " << outputFile << std::endl;
